...
const CustomerComplaints: React.FC<CustomerComplaintsProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-medium mb-3">Submit New Complaint</h2>
      ...
      <div>
        <h2 className="text-lg font-medium mb-3">Previous Complaints</h2>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <div>
                    <div className="font-medium">
                      {complaint.resolved ? 'Resolved' : 'Open Complaint'}
                    </div>
