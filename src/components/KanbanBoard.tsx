      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex gap-4 min-w-max">
          {ALL_STATUSES.map((status, columnIndex) => (
            ...
            >
              <div className="flex items-center justify-between mb-2 bg-secondary/80 dark:bg-gray-800 p-2 rounded-lg">
                <h3 className="font-medium text-sm flex items-center gap-1.5">
                  <OrderStatusBadge status={status} />
                </h3>
                <span className="text-xs font-semibold bg-secondary dark:bg-gray-700 text-muted-foreground dark:text-gray-300 rounded-full px-2 py-0.5">
