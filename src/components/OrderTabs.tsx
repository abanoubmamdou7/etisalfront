...
const OrderCard = ({ order, index }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="p-4 h-full transition-all duration-300 hover:shadow-md dark:bg-gray-800 dark:border-gray-700">
  ...
  return (
    <Tabs defaultValue="all" className="w-full" onValueChange={(value) => setSelectedStatus(value as OrderStatus | 'all')}>
      <div className="mb-6 overflow-x-auto pb-2 no-scrollbar">
        <TabsList className="bg-secondary/80 dark:bg-gray-800/80 p-1 rounded-full">
          <TabsTrigger 
            value="all" 
            className="rounded-full data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-primary dark:data-[state=active]:text-white data-[state=active]:shadow-sm transition-all duration-200"
          >
          ...
          {ALL_STATUSES.map((status) => (
            <TabsTrigger
              key={status}
              value={status}
              className="rounded-full data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700 data-[state=active]:text-primary dark:data-[state=active]:text-white data-[state=active]:shadow-sm transition-all duration-200 flex items-center gap-1"
            >
